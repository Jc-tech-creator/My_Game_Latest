...
public class TwitchService {
    ...
    public List<Stream> getStreams(List<String> gameIds, int first) {// FIRST MEANS the first xxx result
        if (token == null) {
            token = twitchIdentityClient.requestAccessToken(twitchClientId, twitchSecret, "client_credentials");
        }
        try {
    ...
    public List<Clip> getClips(String gameId, int first) {// FIRST MEANS the first xxx result
        if (token == null) {
            token = twitchIdentityClient.requestAccessToken(twitchClientId, twitchSecret, "client_credentials");
        }
        try {
