...
//this means all the following api mapped to this url, no need to specify later
public class FavoriteController {
    ...
    @GetMapping
    public TypeGroupedItemList getFavoriteItems(@AuthenticationPrincipal User user){//@AuthenticationPrincipal means 提供当前已经登录的用户的Info, refer to UserService
